...
urlpatterns = [
    ...
    path('operations/agent-installer/', technician_agent_installer, name='technician_agent_installer'),
    ...
    path('client/signup/', client_trial_signup, name='client_trial_signup'),
    path('client/logout/', client_logout, name='client_logout'),
    path('client/', client_dashboard, name='client_dashboard'),
    path('client/agent/download/', client_download_agent, name='client_download_agent'),
    path('client/agent/test-connection/', client_agent_connection_test, name='client_agent_connection_test'),
    ...
    path('client/machine/<int:machine_id>/', client_machine_detail, name='client_machine_detail'),
